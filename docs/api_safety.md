...
- `spec_get_filter_status` - hardware behavior recorded: `yes`; test level: `hardware_readonly`
- `spec_get_filter_model` - hardware behavior recorded: `yes`; test level: `hardware_readonly`
- `spec_get_filter_limit` - hardware behavior recorded: `yes`; test level: `hardware_readonly`
- `spec_get_slit_zero_pos` - hardware behavior recorded: `yes`; test level: `hardware_readonly`
- `spec_get_slit_model` - hardware behavior recorded: `yes`; test level: `hardware_readonly`
- `spec_get_shutter_status` - hardware behavior recorded: `yes`; test level: `hardware_readonly`
- `spec_is_setup_filter` - hardware behavior recorded: `yes`; test level: `hardware_readonly`
- `spec_is_setup_mirror` - hardware behavior recorded: `yes`; test level: `hardware_readonly`
- `spec_is_setup_slit` - hardware behavior recorded: `yes`; test level: `hardware_readonly`
- `spec_is_setup_shutter` - hardware behavior recorded: `yes`; test level: `hardware_readonly`
...
- `spec_get_zero_offset` - hardware behavior recorded: `yes`; test level: `manual-only`
- `spec_get_dispersion` - hardware behavior recorded: `yes`; test level: `hardware_readonly-observed-error`
- `spec_get_filter` - hardware behavior recorded: `yes`; test level: `hardware_readonly-observed-error`
...
- `spec_get_slit_width` - hardware behavior recorded: `yes`; test level: `hardware_readonly-observed-error`
- `spec_get_slit_bandpass` - hardware behavior recorded: `yes`; test level: `hardware_readonly-observed-error`
...
- `spec_get_zero_pos` - hardware behavior recorded: `yes`; test level: `manual-only`
- `spec_get_adjustment` - hardware behavior recorded: `yes`; test level: `manual-only`
- `spec_set_move_speed` - hardware behavior recorded: `no`; test level: `experimental/no-hardware`
- `spec_get_side_exit_pos` - hardware behavior recorded: `no`; test level: `experimental/no-hardware`
- `spec_get_side_entrance_pos` - hardware behavior recorded: `no`; test level: `experimental/no-hardware`
- `spec_get_motor_steps` - hardware behavior recorded: `no`; test level: `experimental/no-hardware`
- `spec_get_motor_speed` - hardware behavior recorded: `no`; test level: `experimental/no-hardware`
- `spec_get_motor_home_dir` - hardware behavior recorded: `no`; test level: `experimental/no-hardware`
- `spec_get_motor_total_steps` - hardware behavior recorded: `no`; test level: `experimental/no-hardware`
- `spec_set_shutter_status` - hardware behavior recorded: `no`; test level: `experimental/no-hardware`
- `spec_get_correct_params` - hardware behavior recorded: `no`; test level: `experimental/no-hardware`
- `spec_wave_to_step` - hardware behavior recorded: `yes`; test level: `hardware_readonly-experimental`
- `spec_pixels_to_waves` - hardware behavior recorded: `no`; test level: `experimental/no-hardware`
- `spec_get_init_peripherals` - hardware behavior recorded: `no`; test level: `experimental/no-hardware`
- `spec_get_peripherals_init_pos` - hardware behavior recorded: `no`; test level: `experimental/no-hardware`
- `spec_get_trig_out_interval` - hardware behavior recorded: `no`; test level: `experimental/no-hardware`
- `spec_get_trig_in_interval` - hardware behavior recorded: `no`; test level: `experimental/no-hardware`
- `spec_get_ccd_mode` - hardware behavior recorded: `no`; test level: `experimental/no-hardware`
- `spec_init_spectral_splice` - hardware behavior recorded: `no`; test level: `experimental/no-hardware`
- `spec_init_spectral_splice2` - hardware behavior recorded: `no`; test level: `experimental/no-hardware`
- `spec_spectral_splice` - hardware behavior recorded: `no`; test level: `experimental/no-hardware`
- `spec_get_diaphragm` - hardware behavior recorded: `no`; test level: `experimental/no-hardware`
- `spec_get_diaphragm_steps` - hardware behavior recorded: `no`; test level: `experimental/no-hardware`
- `spec_get_focus_mirror` - hardware behavior recorded: `no`; test level: `experimental/no-hardware`
- `spec_get_focus_mirror_steps` - hardware behavior recorded: `no`; test level: `experimental/no-hardware`
